...
const NotFound = () => {
  ...
  return (
    <div className="flex flex-col w-screen h-screen items-center justify-center text-sm  px-4">
      <p className="font-medium text-lg text-indigo-500">404 Error</p>
      <h2 className="md:text-6xl text-4xl font-semibold text-[#0f172a]">Page Not Found</h2>
